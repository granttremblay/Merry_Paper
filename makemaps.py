...
starmap_hdulist = fits.open("stellar_vel_map.fits")
starmap_image_data = starmap_hdulist[0].data


plt.figure(figsize=(8, 8))
plt.imshow(starmap_image_data, interpolation="nearest", origin='lower',cmap=plt.cm.coolwarm, vmin=-200, vmax=200)
